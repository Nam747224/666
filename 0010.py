...
videos = {
    "Sơn Tùng MTP": [
        ("Nơi Này Có Anh", "https://youtu.be/FN7ALfpGxiI?si=LyAzWm7j8wvs9vMn"),
        ("Hãy Trao Cho Anh", "https://youtu.be/knW7-x7Y7RE?si=HLrjHmanrk-ME5XR"),
        ("Buông Đôi Tay Nhau Ra", "https://youtu.be/LCyo565N_5w?si=Or7t-hDjc6KmTDR1"),
        ("Lạc Trôi", "https://youtu.be/Llw9Q6akRo4?si=GNo5PPJKdf5BVl46"),
        ("Cơn Mưa Ngang Qua", "https://youtu.be/r1OtnOs-utU?si=qyaXtT6lHKVH2AHr")

    ],
    "BigBang": [
        ("Fantastic Baby", "https://youtu.be/AAbokV76tkU?si=hNeTQO9wpRnWYuna"),
        ("Bang Bang Bang", "https://youtu.be/2ips2mM7Zqw?si=p2qxiOAfEoE1U89t"),
        ("Sober", "https://youtu.be/MBNQgq56egk?si=k_qI1JMorItiiD9h"),
        ("Haru Haru", "https://youtu.be/MzCbEdtNbJ0?si=IJE_8T2IYokwj6Xq"),
        ("Blue", "https://youtu.be/2GRP1rkE4O0?si=gYtsvCVmIax3Ej_3")
    ],

    "TheFatRat": [
        ("Unity", "https://youtu.be/n8X9_MgEdCg?si=r_o4Nubw2aqLTK3K"),
        ("Monody", "https://youtu.be/B7xai5u_tnk?si=EdFP4VwFSKdS0Jc2"),
        ("Fly Away", "https://youtu.be/cMg8KaMdDYo?si=kszLQpSyLQt1qfJs"),
        ("Jackpot", "https://youtu.be/kL8CyVqzmkc?si=2tNM0GZN35cDIB2K"),
        ("Time Lapse", "https://youtu.be/3fxq7kqyWO8?si=EuAzonPlE38335gA")

    ],

    "Khác": [
        ("The Spectre", "https://youtu.be/wJnBTPUQS5A?si=afqn8eOIHBFlEPDY"),
        ("Faded", "https://youtu.be/60ItHLz5WEA?si=VDLwZk0CyoXNZbld"),
        ("Gangnam Style", "https://youtu.be/9bZkp7q19f0?si=5A3G_mqmxSTLQj0W"),
        ("Counting Star", "https://youtu.be/hT_nvWreIhg?si=H43AGnJky4MKFRAI"),
        ("Good Boy", "https://youtu.be/1ZRb1we80kM?si=PkyWFpglTaF3R4q8")
    ]
